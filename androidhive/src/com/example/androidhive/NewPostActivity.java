...
public class NewPostActivity extends Activity {
    ...
    private static String url_create_post = "create_post.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Create button
        Button btnCreatePost= (Button) findViewById(R.id.btnCreatePost);
    ...
    class CreateNewPost extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_create_post,
                    "POST", params);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent i = new Intent(getApplicationContext(), AllPostsActivity.class);
                    startActivity(i);
